...
import {Platform,StyleSheet,Text,Keyboard,KeyboardAvoidingView,Alert,View,Dimensions,TextInput,ScrollView,Image,TouchableOpacity} from 'react-native';
...
export default class Profile extends React.Component {
    ...
    render() {
      return (
          <View style={[globalStyles.COMMON_STYLES.background,{paddingTop:24}]}>
                  <ScrollView>
